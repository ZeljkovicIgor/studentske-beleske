...
/* harmony import */ var _datepicker__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./datepicker */ "./resources/js/datepicker.js");
__webpack_require__(/*! ./bootstrap */ "./resources/js/bootstrap.js");



window.Alpine = alpinejs__WEBPACK_IMPORTED_MODULE_0__["default"];
alpinejs__WEBPACK_IMPORTED_MODULE_0__["default"].data("modalDialog", function () {
  return {
    openModal: false,
    hrefModal: "",
    elementTitle: "",
    modalBtn: function modalBtn() {
      var hrefModal = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : "";
      var elementTitle = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : "";
      this.openModal = true;
...
alpinejs__WEBPACK_IMPORTED_MODULE_0__["default"].data("quillField", function () {
  return {
    quillSubmit: function quillSubmit(refs) {
      var quill = new Quill("#editor");
      refs.contentField.value = quill.root.innerHTML;
    }
  };
});
alpinejs__WEBPACK_IMPORTED_MODULE_0__["default"].data("datepicker", _datepicker__WEBPACK_IMPORTED_MODULE_1__["default"]);
...
function app() {
  return {
    ...
    initDate: function initDate() {
      var existingDate = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : "";
      var today;
    ...
    formatDateForDisplay: function formatDateForDisplay(date) {
      var formattedDay = this.DAYS[date.getDay()];
      var formattedDate = ("0" + date.getDate()).slice(-2); // appends 0 (zero) in single digit date

      var formattedMonth = this.MONTH_NAMES[date.getMonth()];
      var formattedMonthShortName = this.MONTH_SHORT_NAMES[date.getMonth()];
