<div x-data="datepicker" x-init="[initDate('{{ $existingDate }}'), getNoOfDays()]" x-cloak>
    <div class="relative mt-2 z-50">
        ...
        <input type="text" x-on:click="showDatepicker = !showDatepicker" x-model="datepickerValue"
            ...
            placeholder="Izaberite datum" readonly />
        ...
        <div class="bg-white mt-12 rounded-lg shadow p-4 absolute top-2 left-0" x-show.transition="showDatepicker"
